  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      ...
      <div onClick={handleNav} className='block md:hidden'>
        {nav ? <AiOutlineClose size={20} className='fixed right-4 top-7' color={'#00df9a'} /> : <AiOutlineMenu size={20} className='fixed right-4 top-7' color={'#00df9a'} />}
      </div>
      <div className={!nav ? 'z-10 fixed left-[-100%] ease-in-out duration-500' : 'z-10 fixed left-0 top-0 w-[60%] h-full border-r-gray-500 border-r-4 bg-[#000300] ease-in-out duration-500'}>
